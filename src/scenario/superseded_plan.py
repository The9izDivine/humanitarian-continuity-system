"""Superseded response-plan dispatch scenario."""
...
class SupersededPlanScenarioOrchestrator:
    """Run a response scenario whose plan is superseded before dispatch."""
    ...
    def run(self) -> ScenarioRunResult:
        ...
        response_plan["plan_status"] = "SUPERSEDED"
        response_plan["superseded_by"] = "PLAN-000002"
