"""Insufficient-evidence dispatch scenario."""
...
class InsufficientEvidenceScenarioOrchestrator:
    """Run a response scenario with missing mandatory resource evidence."""
    ...
    def run(self) -> ScenarioRunResult:
        ...
        first_resource = resource_engine.evaluate(
        ...
        resource_results = (first_resource,)
